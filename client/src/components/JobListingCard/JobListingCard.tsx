        ...
        <div className="flex-1 flex flex-col justify-between">
          <div className="flex justify-between items-start">
            <div>
              <Link
                href={`/${item.jobId}`}
                className="text-sm sm:text-lg font-semibold text-primary-color hover:underline text-ellipsis line-clamp-2 dark:text-gray-200"
              >
                {item.jobTitle}
              </Link>
              <p className="flex gap-2 mt-2 items-center text-sm text-gray-600 dark:text-gray-200">
          ...
          <p className="text-sm font-light text-gray-700 mt-2 line-clamp-2 dark:text-gray-400">
            {item.jobDescription}
          </p>
