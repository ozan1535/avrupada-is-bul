        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-2 text-gray-300">
              <MapPin size={16} />
              <span className="text-sm">Avrupa Geneli</span>
            </div>
          </div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  ...
                  className="text-gray-300 hover:text-[#0a66c2] text-sm transition-colors duration-200"
                >
              ...
              <li>
                <a
                  ...
                  className="text-gray-300 hover:text-[#0a66c2] text-sm transition-colors duration-200"
                >
                  Avrupa’da Çalışmak İçin En Çok Tercih Edilen 10 Ülke
                </a>
              </li>
              <li>
                <a
                  ...
                  className="text-gray-300 hover:text-[#0a66c2] text-sm transition-colors duration-200"
                >
                  Avrupa’da İş Ararken Dikkat Etmeniz Gereken 7 Önemli Adım
                </a>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2 text-gray-300">
                <Mail size={16} />
                <a
                  href="mailto:destek.uluslararasikariyer"
                  className="text-sm hover:text-[#0a66c2] transition-colors duration-200"
                >
            ...
            {/* Social Media */}
            <div className="pt-2">
              <p className="text-sm text-gray-300 mb-3">Takip Edin:</p>
              <div className="flex space-x-4">
                <a
                  href="https://www.facebook.com/uluslararasi.kariyer/"
                  target="_blank"
                ...
                <a
                  href="https://www.instagram.com/uluslararasi_kariyer/"
                  target="_blank"
                  className="text-gray-300 hover:text-[#0a66c2] transition-colors duration-200"
                >
                  <svg
