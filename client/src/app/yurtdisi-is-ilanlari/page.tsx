    ...
    <div className="w-full sm:mt-5">
      <div className="flex justify-between gap-2">
        ...
        {/* <div className="w-full md:w-1/4 md:sticky md:top-20">
          <div className="bg-white p-4 rounded shadow md:flex md:flex-col hidden">
            <h5 className="font-medium text-lg">Bizi Takip Edin</h5>
            ...
            <div className="mt-6">
              <h5 className="font-medium text-lg">Önerilen Bloglar</h5>
            </div>

            <div className="mt-6">
              <h5 className="font-medium text-lg">Araçlar</h5>
            </div>
          </div>
        </div> */}
      </div>
